...
func (c *FakeComputeInstanceClaimParameterses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeInstanceClaimParameters, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(computeinstanceclaimparametersesResource, c.ns, name), &v1alpha1.ComputeInstanceClaimParameters{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ComputeInstanceClaimParameters), err
}
...
func (c *FakeComputeInstanceClaimParameterses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeInstanceClaimParametersList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(computeinstanceclaimparametersesResource, computeinstanceclaimparametersesKind, c.ns, opts), &v1alpha1.ComputeInstanceClaimParametersList{})
	...
	list := &v1alpha1.ComputeInstanceClaimParametersList{ListMeta: obj.(*v1alpha1.ComputeInstanceClaimParametersList).ListMeta}
	for _, item := range obj.(*v1alpha1.ComputeInstanceClaimParametersList).Items {
...
func (c *FakeComputeInstanceClaimParameterses) Create(ctx context.Context, computeInstanceClaimParameters *v1alpha1.ComputeInstanceClaimParameters, opts v1.CreateOptions) (result *v1alpha1.ComputeInstanceClaimParameters, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(computeinstanceclaimparametersesResource, c.ns, computeInstanceClaimParameters), &v1alpha1.ComputeInstanceClaimParameters{})
...
func (c *FakeComputeInstanceClaimParameterses) Update(ctx context.Context, computeInstanceClaimParameters *v1alpha1.ComputeInstanceClaimParameters, opts v1.UpdateOptions) (result *v1alpha1.ComputeInstanceClaimParameters, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(computeinstanceclaimparametersesResource, c.ns, computeInstanceClaimParameters), &v1alpha1.ComputeInstanceClaimParameters{})
...
func (c *FakeComputeInstanceClaimParameterses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(computeinstanceclaimparametersesResource, c.ns, name, opts), &v1alpha1.ComputeInstanceClaimParameters{})
...
func (c *FakeComputeInstanceClaimParameterses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.ComputeInstanceClaimParametersList{})
	return err
}
...
func (c *FakeComputeInstanceClaimParameterses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeInstanceClaimParameters, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(computeinstanceclaimparametersesResource, c.ns, name, pt, data, subresources...), &v1alpha1.ComputeInstanceClaimParameters{})
