	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.DraV1().Gpus(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DraV1().Gpus(namespace).Watch(context.TODO(), options)
			},
		},
		&nvidiav1.Gpu{},
		resyncPeriod,
...
func (f *gpuInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&nvidiav1.Gpu{}, f.defaultInformer)
}
