...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RequestedDevice) DeepCopyInto(out *RequestedDevice) {
	*out = *in
	if in.Gpu != nil {
		in, out := &in.Gpu, &out.Gpu
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RequestedDevice.
func (in *RequestedDevice) DeepCopy() *RequestedDevice {
	if in == nil {
		return nil
	}
	out := new(RequestedDevice)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RequestedDevices) DeepCopyInto(out *RequestedDevices) {
	*out = *in
	...
	if in.Devices != nil {
		...
		*out = make([]RequestedDevice, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RequestedDevicesSpec) DeepCopyInto(out *RequestedDevicesSpec) {
	*out = *in
	if in.Gpu != nil {
		in, out := &in.Gpu, &out.Gpu
		*out = new(GpuClaimSpec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RequestedDevicesSpec.
func (in *RequestedDevicesSpec) DeepCopy() *RequestedDevicesSpec {
	if in == nil {
		return nil
	}
	out := new(RequestedDevicesSpec)
	in.DeepCopyInto(out)
	return out
}
