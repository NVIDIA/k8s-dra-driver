...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CudaTimeSlicingSettings) DeepCopyInto(out *CudaTimeSlicingSettings) {
	*out = *in
	if in.TimeSlice != nil {
		in, out := &in.TimeSlice, &out.TimeSlice
		*out = new(CudaTimeSliceConfig)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CudaTimeSlicingSettings.
func (in *CudaTimeSlicingSettings) DeepCopy() *CudaTimeSlicingSettings {
	if in == nil {
		return nil
	}
	out := new(CudaTimeSlicingSettings)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GpuSharing) DeepCopyInto(out *GpuSharing) {
	*out = *in
	if in.TimeSlicingSettings != nil {
		in, out := &in.TimeSlicingSettings, &out.TimeSlicingSettings
		*out = new(CudaTimeSlicingSettings)
		(*in).DeepCopyInto(*out)
	}
}
